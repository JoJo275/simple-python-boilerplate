"""Unit tests for tools/dev_tools/env_dashboard/routes.py."""
...
from tools.dev_tools.env_dashboard.routes import _parse_tier

# ---------------------------------------------------------------------------
# _parse_tier (routes module has its own copy)
# ---------------------------------------------------------------------------


class TestRoutesParserTier:
    """Tests for the routes._parse_tier helper."""
    ...
    def test_invalid_falls_back_to_standard(self) -> None:
        assert _parse_tier("invalid") == Tier.STANDARD
