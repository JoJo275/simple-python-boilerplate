...
Step-by-step execution plan. Order matters — later steps may depend on
earlier ones.
...
|---|------|---------------|-------|
| 1 | Description | `path/to/file` | Details |
| 2 | Description | `path/to/file` | Details |

### Phase 2: [Name]

| # | Task | Files changed | Notes |
|---|------|---------------|-------|
| 3 | Description | `path/to/file` | Details |
| 4 | Description | `path/to/file` | Details |

<!-- Add more phases as needed. Keep phases small enough to be
